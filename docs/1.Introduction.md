...
The strategies are configurable per strategy. You can also define the priority of the strategies used. More information about strategies can be found at the [strategies](https://github.com/juriansluiman/SlmLocale/blob/master/docs/1.Strategies.md) page.